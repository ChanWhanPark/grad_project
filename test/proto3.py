...
def update_line(lidar, iterator, max_degree, min_degree, max_distance):
...
def test(l, r):
    ...
    count = 0
    while True:
        angle_deg, distance, left, right = update_line(lidar=lidar, iterator=iterator, max_degree=360, min_degree=0, max_distance=600)
